...
export default {
  pages: {
    key: 'title',
    data: [
      { title: 'داشبورد', route: { name: 'dashboard' }, icon: 'HomeIcon', isBookmarked: true },
      { title: 'سفارشات', route: { name: 'orders' }, icon: 'LayersIcon', isBookmarked: true },
      { title: 'معاملات', route: { name: 'trades' }, icon: 'PercentIcon', isBookmarked: true },
      { title: 'تراکنش های رمز ارز', route: { name: 'tr-crypto' }, icon: 'SlackIcon', isBookmarked: false },
      { title: 'تراکنش های داخلی', route: { name: 'tr-internal' }, icon: 'SlidersIcon', isBookmarked: false },
      { title: 'کارت های بانکی', route: { name: 'card-bank' }, icon: 'CreditCardIcon', isBookmarked: false },
      { title: 'کاربران', route: { name: 'users' }, icon: 'UsersIcon', isBookmarked: true },
      { title: 'تراکنش های رفرال', route: { name: 'referral-transaction' }, icon: 'DollarSignIcon', isBookmarked: false },
      { title: 'لیست رفرال', route: { name: 'referral-users' }, icon: 'UserPlusIcon', isBookmarked: false },
      { title: 'رمز ارز ها', route: { name: 'cryptos' }, icon: 'CommandIcon', isBookmarked: false },
    ],
  },
  files: {
    key: 'file_name',
