        ...
        <b-card-body>
            <b-row>
                ...
                <b-col cols="12" md="3" class="mb-md-0 mb-2">
                        ...
                        <b-form-input placeholder="مبلغ سفارش از" v-model="amountStart"/>
                </b-col>
                <b-col cols="12" md="3" class="mb-md-0 mb-2">
                    <label>مبلغ کل تا</label>
                    <b-form-input placeholder="مبلغ سفارش تا" v-model="amountStop"/>
                </b-col>
                <b-col cols="12" md="3" class="mb-md-0 mb-2" >
                    <label>طریقه</label>
                    <v-select
                ...
                <b-col cols="12" md="3" class="mb-md-0 mb-2">
                    ...
                    <b-form-input placeholder="چند شناسه با درج , بین اعداد" v-model="id"/>
                </b-col>
                ...
                <b-col cols="12" md="3" class="mb-md-0 mb-2 mt-1">
                    <label>شناسه سفارش و نمایش تراکنشهای آن</label>
                    <b-form-input placeholder="چند شناسه با درج , بین اعداد" v-model="idOrders"/>
                </b-col>
                <b-col cols="12" md="3" class="mb-md-0 mb-2 mt-1">
                    <label>شناسه معامله و نمایش تراکنشهای آن</label>
                    <b-form-input placeholder="چند شناسه با درج , بین اعداد" v-model="idTrades"/>
                </b-col>
            </b-row>
        </b-card-body>
    </b-card-actions>
...
<script>
    ...
    export default {
        ...
        watch:{
            ...
            idOrders(val){
                this.$emit('update:idOrdersFilter', val)
            },
            idTrades(val){
                this.$emit('update:idTradesFilter', val)
            },
            isLoading(val){
                if(!val)
