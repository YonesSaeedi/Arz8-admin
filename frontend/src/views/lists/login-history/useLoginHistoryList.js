...
export default function useUsersList(props = null) {
    ...
    const tableColumns = [
        ...
        {key: 'os', label: 'سیستم عامل', sortable: true},
        {key: 'device', label: 'دستگاه', sortable: true},
        {key: 'browser', label: 'مرورگر', sortable: true},
        {key: 'date', label: 'تاریخ ثبت', sortable: true},
        {key: 'twofa', label: 'دو مرحله ای',sortable: true},
        {key: 'agent', label: '#'},
    ];
