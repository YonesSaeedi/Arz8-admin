<template>
    <div>
        ...
        <deposit-id-filters
            ...
            :bank-filter.sync="bankFilter" :bank-options="bankOption" v-if="bankOption.length>0"
        ...
        <b-card no-body class="mb-0">
            ...
            >
                ...
                <template #cell(depositId)="data">
                    <div class="text-nowrap">
                        <span>{{$t(data.item.payment_gateway)}}<br>{{data.item.deposit_id}}</span>
                    </div>
                </template>
...
<script>
    ...
    import DepositIdFilters from './DepositIdFilters.vue'
    import useDepositIdList from './useDepositIdList'
