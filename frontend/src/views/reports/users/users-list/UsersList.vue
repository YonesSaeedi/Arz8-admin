<template>
    <div>
        ...
        <users-list-filters
            ...
            :sort-filter.sync="sortFilter" :sort-options="sortOptions"
        ...
        >
            ...
            >
                ...
                <template #cell(amount)="data">
                    <div class="text-nowrap">
                        <span>{{ data.item.amount ? data.item.amount.toLocaleString('en-US') : '-------' }}</span>
                    </div>
                </template>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const sortOptions = [
                {label: 'حجم خرید و فروش', value: 'amountOrders'},
                {label: 'حجم خرید', value: 'amountOrdersBuy'},
                {label: 'حجم فروش', value: 'amountOrdersSell'},
                {label: 'تعداد خرید و فروش', value: 'countOrders'},
                {label: 'تعداد معاملات', value: 'countTrades'},
                {label: 'تعداد معرفی یا رفرال', value: 'countReferral'},
                {label: 'تعداد تراکنش های رفرال', value: 'countReferralTr'},
                {label: 'مبلغ تراکنش های رفرال', value: 'countReferralTrAmount'},
                {label: 'تعداد گردونه شانس', value: 'countWheel'},
                {label: 'مبلغ جایزه گردونه شانس', value: 'countWheelAmount'},
            ]
