<template>
    <div v-if="formData">
        <validation-observer
            v-if="accessUserLogin['setting']['perfectmoney'] || activeUserInfo.role === 'admin'"
        ...
        >
            ...
            >
                ...
                <b-card title="تنظیمات پرفکت مانی">
                    <b-row>
                        <b-col cols="4">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="شناسه اکانت (account id)">
                                    <b-form-input dir="ltr" class="text-center"
                                        v-model="formData.perfectmoney.account_id"
                        ...
                        <b-col cols="4">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="پسورد">
                                    <b-form-input dir="ltr" class="text-center"
                                        v-model="formData.perfectmoney.password"
                                        :state="errors.length > 0 ? false:null"
                        ...
                        <b-col cols="4">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="اکانت اصلی">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.perfectmoney.payer_account"
                                                  :state="errors.length > 0 ? false:null"
                    ...
                    <div class="demo-inline-spacing w-50">
                        <b-form-radio
                            v-model="formData.perfectmoney.price_api_status"
                            name="api_status"
                            value="true"
                        ...
                        <b-col cols="6">
                            <validation-provider #default="{ errors }" rules="required|between:60000,120000">
                                <b-form-group label="قیمت خرید پرفکت مانی">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.perfectmoney.price_api_status === 'true'"
                                                  v-model="formData.perfectmoney.price.buy"
                                                  :state="errors.length > 0 ? false:null"
                        ...
                        <b-col cols="6">
                            <validation-provider #default="{ errors }" rules="required|between:60000,120000">
                                <b-form-group label="قیمت فروش پرفکت مانی">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.perfectmoney.price_api_status === 'true'"
                                                  v-model="formData.perfectmoney.price.sell"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="قیمت خرید پرفکت مانی"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="محاسبه درصد یا ضریب خرید(بالای صد به تومان)" label-for="name">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.perfectmoney.price_api_status !== 'true'"
                                                  v-model="formData.perfectmoney.price_percent_buy"
                                                  :state="errors.length > 0 ? false:null"
                        ...
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="محاسبه درصد یا ضریب فروش(بالای صد به تومان)" label-for="name">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.perfectmoney.price_api_status !== 'true'"
                                                  v-model="formData.perfectmoney.price_percent_sell"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="بالای 100 به تومان"
                                    />
                                </b-form-group>
                    ...
                    <b-row>
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="کارمزد خرید(بالای صد به تومان)" >
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.perfectmoney.wageBuy"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="بالای 100 به تومان"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="کارمزد فروش(بالای صد به تومان)">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.perfectmoney.wageSell"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="بالای 100 به تومان"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="6" class="mt-1">
                            <validation-provider #default="{ errors }" rules="required|between:60000,120000">
                                <b-form-group label="حداقل مجاز برای خرید">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.perfectmoney.min_buy"
                                                  :state="errors.length > 0 ? false:null"
                        ...
                        <b-col cols="6">
                            ...
                            <div class="demo-inline-spacing w-50">
                                <b-form-radio
                                    v-model="formData.perfectmoney.buy_status"
                                    name="buy_status"
                                    value="true"
                                    class="custom-control-warning mt-0"
                                >
                        ...
                        <b-col cols="6">
                            ...
                            <div class="demo-inline-spacing w-50">
                                <b-form-radio
                                    v-model="formData.perfectmoney.sell_status"
                                    name="sell_status"
                                    value="true"
                                    class="custom-control-warning mt-0"
                                >
