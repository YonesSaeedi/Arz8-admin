<template>
    <div v-if="formData">
        <validation-observer
            v-if="accessUserLogin['setting']['payeer'] || activeUserInfo.role === 'admin'"
        ...
        >
            ...
            >
                ...
                <b-card title="تنظیمات پاییر">
                    <b-row>
                        <b-col cols="4">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="شناسه اکانت (account number)">
                                    <b-form-input dir="ltr" class="text-center"
                                        v-model="formData.payeer.account_number"
                        ...
                        <b-col cols="4">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="شناسه اپلیکیشن app id">
                                    <b-form-input dir="ltr" class="text-center"
                                        v-model="formData.payeer.app_id"
                                        :state="errors.length > 0 ? false:null"
                                        placeholder="app id"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="4">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="api key">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.payeer.api_key"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="api key"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="4" class="mt-1">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="شناسه فروشگاه (shop id)">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.payeer.shop_id"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="shop id"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="8" class="mt-1">
                            <validation-provider #default="{ errors }" rules="required">
                                <b-form-group label="شناسه اپلیکیشن فروشگاه (shop id applications)">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.payeer.shop_id_applications"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="shop id applications"
                                    />
                                </b-form-group>
                            </validation-provider>
                        </b-col>
                    ...
                    <div class="demo-inline-spacing w-50">
                        <b-form-radio
                            v-model="formData.payeer.price_api_status"
                            name="api_status"
                            value="true"
                        ...
                        <b-col cols="6">
                            <validation-provider #default="{ errors }" rules="required|between:60000,120000">
                                <b-form-group label="قیمت خرید پرفکت مانی">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.payeer.price_api_status === 'true'"
                                                  v-model="formData.payeer.price.buy"
                                                  :state="errors.length > 0 ? false:null"
                        ...
                        <b-col cols="6">
                            <validation-provider #default="{ errors }" rules="required|between:60000,120000">
                                <b-form-group label="قیمت فروش پرفکت مانی">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.payeer.price_api_status === 'true'"
                                                  v-model="formData.payeer.price.sell"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="قیمت خرید پرفکت مانی"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="محاسبه درصد یا ضریب خرید(بالای صد به تومان)" label-for="name">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.payeer.price_api_status !== 'true'"
                                                  v-model="formData.payeer.price_percent_buy"
                                                  :state="errors.length > 0 ? false:null"
                        ...
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="محاسبه درصد یا ضریب فروش(بالای صد به تومان)" label-for="name">
                                    <b-form-input dir="ltr" class="text-center" :disabled="formData.payeer.price_api_status !== 'true'"
                                                  v-model="formData.payeer.price_percent_sell"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="بالای 100 به تومان"
                                    />
                                </b-form-group>
                    ...
                    <b-row>
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="کارمزد خرید(بالای صد به تومان)" >
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.payeer.wageBuy"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="بالای 100 به تومان"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="6" class="mt-2">
                            <validation-provider #default="{ errors }" rules="required|between:-5000,5000">
                                <b-form-group label="کارمزد فروش(بالای صد به تومان)">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.payeer.wageSell"
                                                  :state="errors.length > 0 ? false:null"
                                                  placeholder="بالای 100 به تومان"
                                    />
                                </b-form-group>
                        ...
                        <b-col cols="6" class="mt-1">
                            <validation-provider #default="{ errors }" rules="required|between:60000,120000">
                                <b-form-group label="حداقل مجاز برای خرید">
                                    <b-form-input dir="ltr" class="text-center"
                                                  v-model="formData.payeer.min_buy"
                                                  :state="errors.length > 0 ? false:null"
                        ...
                        <b-col cols="6">
                            ...
                            <div class="demo-inline-spacing w-50">
                                <b-form-radio
                                    v-model="formData.payeer.buy_status"
                                    name="buy_status"
                                    value="true"
                                    class="custom-control-warning mt-0"
                                >
                        ...
                        <b-col cols="6">
                            ...
                            <div class="demo-inline-spacing w-50">
                                <b-form-radio
                                    v-model="formData.payeer.sell_status"
                                    name="sell_status"
                                    value="true"
                                    class="custom-control-warning mt-0"
                                >
