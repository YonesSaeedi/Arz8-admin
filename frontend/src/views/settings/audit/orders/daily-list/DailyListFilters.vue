<template>
    <b-card-actions no-body action-collapse title="فیلترها" :collapsed="isSmallerScreen">
        <b-card-body>
            <b-row>
                ...
                <b-col cols="12" md="3" class="mb-md-0 mb-2">
                        <label>مبلغ سود از</label>
                        <b-form-input placeholder="مبلغ سود از" v-model="amountStart"/>
                </b-col>
                <b-col cols="12" md="3" class="mb-md-0 mb-2">
                    <label>مبلغ سود تا</label>
                    <b-form-input placeholder="مبلغ سود تا" v-model="amountStop"/>
                </b-col>
            </b-row>
        </b-card-body>
    </b-card-actions>
